      ...
      <section className="container" style={{ paddingBottom: '10rem' }}>
        <div className="contact-layout-split">
          ...
          <div className="contact-details-panel">
            ...
            {/* Map Frame */}
            <div style={{ width: '100%', height: '320px', border: '1px solid var(--border-color)', overflow: 'hidden', marginTop: '2rem', borderRadius: '4px' }}>
              <iframe
                title="Banu Engineering Office Map Location"
                src="https://maps.google.com/maps?q=10.684179,78.610377&t=&z=17&ie=UTF8&iwloc=&output=embed"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
            ...
            <div style={{ marginTop: '0.75rem' }}>
              <a
                href="https://maps.app.goo.gl/ViKUc7aK8bRwYXjJA"
                target="_blank"
